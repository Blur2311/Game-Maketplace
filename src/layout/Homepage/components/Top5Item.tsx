      ...
      <Link to={item.url}>
        <div className="flex flex-col text-white item-start">
          ...
          <div className="overflow-hidden min-w-fit">
              <img src={item.image} alt="" className="rounded-lg top5-items-image" />
            </div>
            <div className="flex flex-col gap-1 xl:gap-2">
              ...
              <div className="item-center flex justify-between gap-1 md:gap-[8px]">
                {item.sale !== 0 ? (<div className="rounded-full bg-mainCyan px-2 py-[2px] text-xs text-black max-block-fit">
                  -{item.sale}%
                </div>) : <></>}
