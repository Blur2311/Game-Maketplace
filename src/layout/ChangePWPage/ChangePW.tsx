  ...
  return (
    <>
      <div className="rounded bg-white p-10">
        ...
        <div className="mt-[50px] max-w-[360px]">
          <div className="">
            ...
            <div className="mt-[25px]">
              ...
              {newError.oldPassword && (
                <p className="text-sm text-red-500">{newError.oldPassword}</p>
              )}
            </div>
          </div>
          <div className="">
            ...
            <div className="mt-[25px]">
              ...
              {newError.newPassword && (
                <p className="text-sm text-red-500">{newError.newPassword}</p>
              )}
            </div>
          </div>
          ...
          <div className="mt-10">
            <FloatLabel className="text-sm">
              <Password
                // toggleMask
                className="w-full"
                inputClassName="border-grayBorder h-[50px] border bg-transparent p-5 ps-[10px] w-full"
                // value={password}
                onChange={(e) =>
            ...
            {newError.confirmPassword && (
              <p className="text-sm text-red-500">{newError.confirmPassword}</p>
            )}
          </div>
          <Button
            label="SAVE CHANGES"
        ...
        <div className="">
          <h5 className="mt-20 text-lg font-bold">Two-Factor Authentication</h5>
          ...
          <div className="mt-10">
            ...
            <div className="mt-[25px]">
              <FloatLabel className="text-sm">
                <InputText
                  // toggleMask
                  className="h-[50px] w-full max-w-[360px] border border-grayBorder bg-transparent p-5 ps-[10px]"
                  // value={password}
